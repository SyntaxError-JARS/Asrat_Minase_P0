...
--Creating an Account table with its attributes. 
...
--Creating a foreign key named fk_SSN that relates account table with customer table
...
--Creating a transaction_History table with its attributes. 
...
--Creating a foreign key named fk_Account_Number that relates account table with transaction_History table
