...
public class CustomerDao implements Genericable<Customer>{
    ...
    public Customer create(Customer newCustomer) {
        ...
        try(Connection conn = ConnectionFactory.getInstance().getConnection();) {
            ...
            ps.setDate(3, newCustomer.getDob());
    ...
    public Customer findById(String id) {
        ...
        try(Connection conn = ConnectionFactory.getInstance().getConnection();){
            ...
            customers.setSsn(rs.getString("ssn"));
            customers.setUsername_u(rs.getString("username_u"));
            customers.setPassword_p(rs.getString("password_p"));
    ...
    public void delete (Connection conn, String tableName, String name) {
        Statement statement;
        try {
        String query = String.format( "delete from %s where first_name = %s", tableName, name);
