...
public class CustomerServices implements Serviceable<Customer>{
    ...
    @Override
    public List<Customer> readById(String id) throws ResourcePersistanceException {

        logger.info("Begin reading Customers in the database using last name.");

        try {
            List<Customer> customer = customerDao.findById(id);
            return customer;
    ...
    public String update(String last_name, String email) {
        ...
        if(updatedCustomer == 0){
            throw new ResourcePersistanceException("Customer was already updated. ");
        }
    ...
    public String delete(String first_name) {
        ...
        if(deletedCustomer == 0){
            throw new ResourcePersistanceException("Customer was not found in the database. ");
        }
    ...
    public Customer create(Customer newCustomer){
        ...
        if(!validateInput(newCustomer)){ // checking if false
            ...
            System.out.println("Please check your input either the customer is already registered or something went wrong.  ");
