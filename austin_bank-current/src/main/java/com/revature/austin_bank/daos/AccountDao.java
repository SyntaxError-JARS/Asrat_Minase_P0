...
public class AccountDao implements Genericable<Account> {
    ...
    public Account create(Account newAccount) {
        try (Connection conn = ConnectionFactory.getInstance().getConnection();) {
            ...
            ps.setString(2, newAccount.getAccountNumber());
            ps.setString(3, newAccount.getAccountType());
            ps.setDouble(4, newAccount.getDepositeAmount());
            ps.setDouble(5, newAccount.getWithdrwalAmount());
            ps.setString(6, newAccount.getRegistrationDate());
            ps.setString(7, newAccount.getSsn());
